...
import com.abhi.repository.CartDao;
import com.abhi.repository.CustomerDao;
import com.abhi.repository.ProductDao;
...
//		return cart.getProducts();
	...
	@Override
	public Cart removeProductFromCart(CartDTO cartDto, String token) throws ProductNotFoundException, CartItemNotFound {
		if(token.contains("customer") == false) {
			throw new LoginException("Invalid session token for customer");
		}
